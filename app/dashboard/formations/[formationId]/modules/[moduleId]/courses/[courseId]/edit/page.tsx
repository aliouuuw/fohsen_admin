...
const mockCourse = {
  ...
  introduction: "La Prise en Charge Intégrée des Maladies de l'Enfant (PCIME) est une approche qui vise à améliorer la santé des enfants de moins de 5 ans. Dans ce module, nous explorerons les différentes stratégies pour identifier, évaluer et traiter les maladies infantiles courantes.",
  objective: "Vous donner les connaissances et outils nécessaires pour identifier et prendre en charge efficacement les maladies courantes chez les enfants.",
  ...
  sections: [
    {
      ...
      content: "Dans beaucoup de villages, les enfants de moins de 5 ans sont particulièrement vulnérables aux maladies. La PCIME permet une approche systématique pour identifier et traiter ces problèmes de santé avant qu'ils ne deviennent graves."
    },
    {
      id: "section2",
      title: "Quels sont les signes de danger ?",
      content: "• L'enfant ne peut pas boire ou téter\n• L'enfant vomit tout ce qu'il consomme\n• L'enfant a des convulsions\n• L'enfant est léthargique ou inconscient"
    }
  ],
  quiz: {
    question: "Mariam amène son fils de 2 ans qui a de la fièvre. Quels signes devez-vous rechercher en priorité ?",
    options: [
        ...
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              Update course content, quizzes, and resources
            </p>
          </div>
        </div>
                ...
                <div>
                  ...
                  {course.quiz.options.map((option, index) => (
                    <div key={index} className="flex items-center gap-2 mb-2">
                      ...
                      />
                      <Select
                        value={course.quiz.correctAnswers.includes(index) ? "correct" : "incorrect"}
